...
HD_PWD='/home/lorsi/Desktop/sinewave_generator_ip/sinewave_generator_ip.runs/system_sinewave_gen_periphe_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_sinewave_gen_periphe_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_sinewave_gen_periphe_0_0.tcl
